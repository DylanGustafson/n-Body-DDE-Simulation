...
#(current_time, position_array) = int_rkf(calcAcc, 0, start, 1, 1e-3, masses)
...
ani = FuncAnimation(fig, update, frames=range(frames), fargs=(points, tails), interval=10)
